...
def test_dns_4460():
    ...
    assert(result.responses[0].abuf_string == "m5GEAAABAAEAAAAABWFzMjUwA25ldAAAAQABwAwAAQABAAAOEAAEwpaoZA==")
...
def test_dns_4470():
    ...
    assert(result.responses[0].protocol == DnsResult.PROTOCOL_UDP)
    assert(result.responses[0].abuf_string == "9iyEAAABAAEAAAAABWFzMjUwA25ldAAAAQABwAwAAQABAAAOEAAEwpaoZA==")
...
def test_dns_4480():
    ...
    assert(result.responses[0].protocol == DnsResult.PROTOCOL_UDP)
    assert(result.responses[0].abuf_string == "MACEAAABAAEAAAAABWFzMjUwA25ldAAAAQABwAwAAQABAAAOEAAEwpaoZA==")
...
def test_dns_4500():
    ...
    assert(result.responses[0].protocol == DnsResult.PROTOCOL_UDP)
    assert(result.responses[0].abuf_string == "35OEAAABAAEAAAAABWFzMjUwA25ldAAAAQABwAwAAQABAAAOEAAEwpaoZA==")
...
def test_dns_4520():
    ...
    assert(result.responses[0].protocol == DnsResult.PROTOCOL_UDP)
    assert(result.responses[0].abuf_string == "BcCEAAABAAEAAAAABWFzMjUwA25ldAAAAQABwAwAAQABAAAOEAAEwpaooA==")
...
def test_dns_4610():
    ...
    assert(result.responses[0].protocol == DnsResult.PROTOCOL_UDP)
    assert(result.responses[0].abuf_string == "PdCEAAABAAEAAAAABWFzMjUwA25ldAAAAQABwAwAAQABAAAOEAAEwpaooA==")
...
def test_resultset():
    ...
    assert(result.responses[0].protocol == DnsResult.PROTOCOL_UDP)
    assert(result.responses[0].abuf_string == "")
