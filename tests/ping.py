...
def test_ping_0():
    ...
    assert(result.last_time_syncronised is None)
...
def test_ping_4550():
    ...
    assert(result.last_time_syncronised == 365)
...
def test_ping_4560():
    ...
    assert(result.last_time_syncronised is 36)
...
def test_ping_4600():
    ...
    assert(result.last_time_syncronised == 222)
...
def test_ping_4610():
    ...
    assert(result.last_time_syncronised == 93)
...
def test_ping_duplicate():
    ...
    assert(result.firmware == 4610)
    assert(result.last_time_syncronised == 38)
...
def test_ping_buggy():
    ...
    assert(result.origin == "62.195.143.53")
    assert(result.firmware == 4600)
    assert(result.last_time_syncronised == 130)
