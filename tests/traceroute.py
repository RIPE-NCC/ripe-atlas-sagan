...
from ..traceroute import TracerouteResult, Hop
from ..traceroute import Packet as TraceroutePacket
...
def test_traceroute_4610():
    ...
    assert(isinstance(result.hops[0].packets[0], TraceroutePacket))
    assert(result.af == 4)
    assert(result.destination_address == "121.244.76.25")
    assert(result.destination_name    == "121.244.76.25")
